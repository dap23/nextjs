                ...
                {editId == 0 && <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='rounded p-3 grid grid-cols-2 gap-3'>
                            ...
                            <input onChange={(e) => handleChange(e)} required placeholder='Harga' name="Harga" type="number" className='p-2 border rounded' />
                        </div>
                ...
                {editId != 0 && <div>
                    ...
                    <form onSubmit={handleUpdate}>
                        <div className='rounded p-3 grid grid-cols-2 gap-3'>
                            ...
                            <input onChange={(e) => handleUpdateChange(e)} required placeholder='Harga' value={editData?.Harga || ""} name="Harga" type="number" className='p-2 border rounded' />
                        </div>
                        <div className='flex justify-end w-full p-3'>
                            <button className='py-2 px-10 border rounded bg-green-400 text-white font-bold'>SIMPAN</button>
                        </div>
