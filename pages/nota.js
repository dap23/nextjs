            ...
            return (
                <div key={el.id} className='grid grid-cols-8 gap-3 text-left text-xs border-b py-3 items-center'>
                    ...
                    <div className='flex justify-end w-full'>
                        ...
                        {el.tipe != "pelunasan" && <button onClick={() => Router.push(`/penjualan-edit/${el.id}`)} className='text-xs bg-yellow-500 ml-1 py-1 px-2 rounded text-white flex items-center'><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
