                ...
                {editId == 0 && <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='rounded p-3 grid grid-cols-2 gap-3'>
                            ...
                            <input type="email" onChange={(e) => handleChange(e)} placeholder='Email' name='email' className='p-2 border rounded' />
                        </div>
                ...
                {editId != 0 && <div>
                    ...
                    <form onSubmit={handleUpdate}>
                        <div className='rounded p-3 grid grid-cols-2 gap-3'>
                            ...
                            <input onChange={(e) => handleUpdateChange(e)} type="email" placeholder='Email' name='email' value={editData?.email || ""} className='p-2 border rounded' />
                        </div>
                        <div className='flex justify-end w-full p-3'>
                            <button className='py-2 px-10 border rounded bg-green-400 text-white font-bold'>SIMPAN</button>
                        </div>
