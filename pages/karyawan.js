  ...
  return (
    <div>
      <div className="flex justify-center my-40">
        ...
        <div className="w-28 mr-3 cursor-pointer">
          <Link href="/karyawan-gaji">
            <div>
              <div className="text-center cursor-pointer rounded-md flex justify-center items-center p-5  hover:bg-green-500 bg-green-500/90 mb-2">
