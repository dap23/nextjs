...
export default function Layout({ children }) {
    return (
        <>
            <div className='transition duration-500 w-full min-h-screen p-5 bg-fixed bg-cover bg-no-repeat bg-center' style={{ backgroundImage: `url("img/bg3.jpg")`, minWidth: "1200px" }}>
